...
## 0:35–1:30 — распределение и приоритет
...
Переключить граф на «Путь от исходного»: даже к этому seed ведёт наблюдаемый
путь от другого исходного узла. Путь не доказывает движение тех же денег.
