...
Найти `100000008346837100` (№ 2 в приоритете; не входит в 81 исходный gid).
Показать 9 плательщиков, 25 получателей, долю крупнейшего получателя 26%,
входящие/исходящие и стрелки. Раскрыть состав приоритета: охват, структура
...
Переключить граф на «Путь от исходного» и показать направленную связь с
исходным узлом. Путь не доказывает движение тех же денег.
